...
#ifndef BSVCOIN_SCRIPT_STANDARD_H
#define BSVCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bsvcoin address
 */
...
/**
 * Generate a Bsvcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BSVCOIN_SCRIPT_STANDARD_H
