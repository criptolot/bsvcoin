...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.bsvcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.bsvcoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.bsvcoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.bsvcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.BSV.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.bsvcoin.sprovoost.nl"); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        vSeeds.emplace_back("seed.bsvcoin.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bsvcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tBSV.petertodd.org");
        vSeeds.emplace_back("seed.testnet.bsvcoin.sprovoost.nl");
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("v7ajjeirttkbnt32wpy3c6w3emwnfr3fkla7hpxcfokr3ysd3kqtzmqd.onion:39444");
