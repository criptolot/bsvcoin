...
#ifndef BSVCOIN_TEST_SCRIPTNUM10_H
#define BSVCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bsvcoin Core 0.10.0, for cross-comparison.
 */
public:
