...
{
    BOOST_CHECK(TestSplitHost("www.bsvcoincore.org", "www.bsvcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bsvcoincore.org]", "www.bsvcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bsvcoincore.org:80", "www.bsvcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bsvcoincore.org]:80", "www.bsvcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::9444", "::9444", 0));
    BOOST_CHECK(TestSplitHost(":9444", "", 9444));
    BOOST_CHECK(TestSplitHost("[]:9444", "", 9444));
