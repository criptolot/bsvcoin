...
#ifndef BSVCOIN_INTERFACES_NODE_H
#define BSVCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bsvcoin node (bsvcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BSVCOIN_INTERFACES_NODE_H
