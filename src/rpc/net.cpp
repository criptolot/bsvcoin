...
static RPCHelpMan addconnection()
{
    return RPCHelpMan{"addconnection",
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"192.168.0.6:9444\" \"outbound-full-relay\"")
            + HelpExampleRpc("addconnection", "\"192.168.0.6:9444\" \"outbound-full-relay\"")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The bsvcoin server IP and port we're connected to"},
...
static RPCHelpMan addpeeraddress()
{
    return RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 9444")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 9444")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    NodeContext& node = EnsureNodeContext(request.context);
