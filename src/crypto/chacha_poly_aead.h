...
#ifndef BSVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BSVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bsvcoin.
 *
 ...
 *
 * The chacha20-poly1305@bsvcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bsvcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bsvcoin are relatively fast in
...
#endif // BSVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
