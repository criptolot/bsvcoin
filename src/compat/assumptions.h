...
#ifndef BSVCOIN_COMPAT_ASSUMPTIONS_H
#define BSVCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Bsvcoin cannot be compiled without assertions."
#endif
...
#endif // BSVCOIN_COMPAT_ASSUMPTIONS_H
