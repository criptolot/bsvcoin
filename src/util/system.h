 ...
 */
#ifndef BSVCOIN_UTIL_SYSTEM_H
#define BSVCOIN_UTIL_SYSTEM_H
...
extern const char * const BSVCOIN_CONF_FILENAME;
extern const char * const BSVCOIN_SETTINGS_FILENAME;
