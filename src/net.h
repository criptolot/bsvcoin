...
#ifndef BSVCOIN_NET_H
#define BSVCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/bsvcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bsvcoin’s Peer-to-Peer Network")
