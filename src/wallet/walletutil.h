...
#ifndef BSVCOIN_WALLET_WALLETUTIL_H
#define BSVCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bsvcoin from opening the wallet, thinking it was newly created, and
...
#endif // BSVCOIN_WALLET_WALLETUTIL_H
