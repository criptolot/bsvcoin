...
#ifndef BSVCOIN_WALLET_ISMINE_H
#define BSVCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/bsvcoin/bsvcoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
