...
#ifndef BSVCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BSVCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bsvcoin Core wallet was originally a collection of unrelated private
...
#endif // BSVCOIN_WALLET_SCRIPTPUBKEYMAN_H
