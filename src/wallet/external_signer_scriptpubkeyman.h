...
#ifndef BSVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BSVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BSVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
