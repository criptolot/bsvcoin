...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, BsvcoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &BsvcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &BsvcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &BsvcoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &BsvcoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &BsvcoinGUI::updateWalletStatus);
    connect(gui, &BsvcoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
