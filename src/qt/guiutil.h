...
#ifndef BSVCOIN_QT_GUIUTIL_H
#define BSVCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Bsvcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bsvcoin:" URI into recipient object, return true on successful parsing
