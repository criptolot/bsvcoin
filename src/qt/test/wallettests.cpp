...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BsvcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_bsvcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_bsvcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_bsvcoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BsvcoinUnits::formatWithUnit(unit, balance, false, BsvcoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    BsvcoinAmountField* amountInput = receiveCoinsDialog.findChild<BsvcoinAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_bsvcoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
