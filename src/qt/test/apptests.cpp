...
//! Entry point for BsvcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BsvcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BsvcoinGUI tests.
void AppTests::guiTests(BsvcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BsvcoinGUI::consoleShown, this, &AppTests::consoleTests);
