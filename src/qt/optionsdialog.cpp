    ...
    mapper(nullptr)
{
    ...
    ui->bsvcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bsvcoinAtStartup);
    ...
    ui->bsvcoinAtStartup->setToolTip(ui->bsvcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bsvcoinAtStartup->setText(ui->bsvcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBsvcoinConfButton->setToolTip(ui->openBsvcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BsvcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bsvcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBsvcoinConfButton_clicked()
{
