...
class TestShell:
    """Wrapper Class for BsvcoinTestFramework.

    The TestShell class extends the BsvcoinTestFramework
    ...
    class __TestShell(BsvcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BsvcoinTestFramework child class.
            self.num_nodes = 1
