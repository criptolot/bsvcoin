...
class WalletSendTest(BsvcoinTestFramework):
    ...
    def run_test(self):
        ...
        for mode in ["economical", "conservative", "BSV/kb", "sat/b"]:
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, change_address="not an address",
                       expect_error=(-5, "Change address must be a valid bsvcoin address"))
