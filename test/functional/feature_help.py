...
"""Verify that starting bsvcoin with -h works as expected."""

from test_framework.test_framework import BsvcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BsvcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bsvcoin with -h for help text")
        ...
        self.log.info("Start bsvcoin with -version for version information")
        ...
        self.log.info("Start bsvcoind with -fakearg to make sure it does not start")
