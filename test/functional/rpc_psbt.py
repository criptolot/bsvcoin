...
class PSBTTest(BsvcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BSV
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 BSV/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
