...
class BumpFeeTest(BsvcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 BSV (100,000 satoshis)
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "BSV/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Bsvcoin to serialize ECDSA signatures means that signatures can have a
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 BSV / 1000 vbytes = 0.00049385 BSV.
    # or occasionally 140 vbytes * fee_rate 0.00350250 BSV / 1000 vbytes = 0.00049035 BSV.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 BSV.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 BSV / 1000 vbytes = 0.00002820 BSV
