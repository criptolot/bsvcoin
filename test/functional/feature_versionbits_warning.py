...
class VersionBitsWarningTest(BsvcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because bsvcoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
