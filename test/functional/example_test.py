...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BsvcoinTestFramework
    pass


class ExampleTest(BsvcoinTestFramework):
    # Each functional test is a subclass of the BsvcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BsvcoinTestFramework class so other tests can use it."""
