...
class P2PPermissionsTests(BsvcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bsvcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bsvcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
