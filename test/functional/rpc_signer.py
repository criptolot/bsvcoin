...
Verify that a bsvcoind node can use an external signer command.
...
class RPCSignerTest(BsvcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bsvcoind with -signer=<cmd>',
