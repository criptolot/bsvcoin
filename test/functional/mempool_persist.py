...
By default, bsvcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BsvcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bsvcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
