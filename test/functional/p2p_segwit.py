...
class SegWitTest(BsvcoinTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older bsvcoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let bsvcoind fill it in.
