...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bsvcoin repository."
  exit 1
fi
...
# See https://github.com/bsvcoin/bsvcoin/issues/16064
...
echo 'When compiling bsvcoind, run `./configure` in the following way:'
echo
