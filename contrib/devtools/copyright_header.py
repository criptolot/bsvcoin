...
Arguments:
    <base_directory> - The base directory of a bsvcoin source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Bsvcoin Core developers'
...
Arguments:
    <file> - A source file in the bsvcoin repository.
"""
