...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BSVCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define BSVCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bsvcoin network\n')
    ...
    g.write('#endif // BSVCOIN_CHAINPARAMSSEEDS_H\n')
