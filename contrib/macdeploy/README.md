...
When complete, it will have produced `Bsvcoin-Core.dmg`.
...
apt install cpio
git clone https://github.com/bsvcoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/bsvcoin-core/bsvcoin-detached-sigs).
