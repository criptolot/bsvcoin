...
bsvcoincore.org and bsvcoin.org and compares them.
...
WORKINGDIR = "/tmp/bsvcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://bsvcoincore.org"
HOST2 = "https://bsvcoin.org"
VERSIONPREFIX = "bsvcoin-core-"
...
def main(args):
    ...
    if not success:
        print("bsvcoin.org failed to provide signature file, "
              "but bsvcoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("bsvcoin.org and bsvcoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Bsvcoin Core binary release "
