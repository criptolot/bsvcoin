# Bootstrappable Bsvcoin Core Builds

This directory contains the files necessary to perform bootstrappable Bsvcoin
Core builds.
...
From the top of a clean Bsvcoin Core repository:
...
To use dongcarl's substitute server for Bsvcoin Core builds after having
