...
// bsvcoin includes.
#include <..\src\script\bsvcoinconsensus.h>
...
int main()
{
    std::cout << "bsvcoinconsensus version: " << bsvcoinconsensus_version() << std::endl;
    ...
    auto op0Result = bsvcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bsvcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
