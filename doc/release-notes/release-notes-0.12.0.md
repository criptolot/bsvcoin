...
Then, to tunnel a SSL connection on 29443 to a RPC server bound on localhost on port 19443 do:

    stunnel -d 29443 -r 127.0.0.1:19443 -p stunnel.pem -P ''
...
- #7209 `f3ad812` test: don't override BSVCOIND and BSVCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add BSVCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "BSV" (Ross Nicoll)
