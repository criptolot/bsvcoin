...
- Instead of running `make` simply, you should instead run
  `BSVCOIN_GENBUILD_NO_GIT=1 make`.
...
- Command line options prefixed with main/test/regtest network names like
  `-main.port=9444` `-test.server=1` previously were allowed but ignored. Now
...
- #17910 Remove double `LIBBSVCOIN_SERVER` linking (fanquake)
...
- #18429 Remove double `LIBBSVCOIN_SERVER` from bench-Makefile (brakmic)
...
- #18341 Replace remaining literal BSV with `CURRENCY_UNIT` (domob1812)
