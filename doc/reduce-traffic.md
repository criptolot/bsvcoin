...
By default, Bsvcoin Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that bsvcoin's trustless model works best if you are
