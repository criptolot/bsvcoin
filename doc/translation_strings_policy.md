...
This document provides guidelines for internationalization of the Bsvcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bsvcoin_en.ts` remains unchanged.
