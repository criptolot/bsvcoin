...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Bsvcoin
else
  DOCKER_EXEC echo \> \$HOME/.bsvcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bsvcoin/bsvcoin/pull/18288#discussion_r433189350 for
  # details.
